    ...
    <div className="relative min-h-screen overflow-hidden bg-ink text-white">
      ...
      <div className="container relative flex min-h-screen items-center justify-center py-16">
        <div className="animate-fade-up w-full max-w-[440px]">
          <Link
            to="/demo"
            className="mb-10 inline-flex items-center gap-2 text-xs font-bold uppercase tracking-[0.12em] text-white/50 transition-colors hover:text-purple"
          >
          ...
          <p className="mb-9 text-center text-[15px] leading-[1.7] text-white/50">{c.subtitle}</p>

          <form onSubmit={onSubmit}>
            <label htmlFor="ca-email" className="mb-2 text-[11px] tracking-[0.14em] text-white/45">
              {c.email}
            </label>
            <input
              id="ca-email"
            ...
            <label
              htmlFor="ca-password"
              className="mb-2 text-[11px] tracking-[0.14em] text-white/45"
            >
              {c.password}
            </label>
            <input
            ...
            {notice && (
              <p
                role="status"
                className="mt-5 rounded-xl border border-purple/30 bg-purple/10 px-4 py-3 text-sm leading-[1.6] text-white/75"
              >
                {c.preview}
              </p>
            )}
          ...
          <div className="mt-8 flex flex-wrap items-center justify-between gap-3 border-t border-white/10 pt-6 text-sm">
            <button
              ...
              className="cursor-pointer border-none bg-transparent p-0 text-white/45 transition-colors hover:text-purple"
            >
              {c.forgot}
            </button>
