import type { Legal } from '../en/legal';
...
const legal: Legal = {
  ...
  docs: [
    ...
    },
    {
      ...
      summary: 'O que guardamos no seu navegador e como o pode recusar.',
      sections: [
        {
        ...
        },
        {
          ...
          paragraphs: [
            'Algumas páginas carregam conteúdo de terceiros, por exemplo os artigos do nosso blogue e os tipos de letra servidos pelo Google Fonts. Esses fornecedores podem receber o seu endereço IP para entregar o conteúdo. A esse tratamento aplicam-se as políticas próprias desses fornecedores.',
          ],
        },
        {
          title: 'Consentimento',
    ...
    },
    {
      ...
      sections: [
        ...
        },
        {
          title: 'Consequências',
          paragraphs: [
            'Podemos suspender ou cessar o acesso sem aviso prévio quando identificarmos uma violação desta política, e comunicar o caso às autoridades competentes quando a lei o exigir.',
          ],
        },
        {
